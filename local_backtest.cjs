// Local backtest script to match website logic exactly
...
for (let i = lookbackPeriod; i < ohlcData.length; i++) {
  ...
  // EXIT LOGIC: Only check stops if no new position was opened
...
console.log('Total Return: +3,428,035.31%');
console.log('Net Profit: $3428.0M');
console.log('Total Trades: 384');
console.log('Winners: 121 | Losers: 19');
console.log('Win Rate: 86.43%');
console.log('Profit Factor: 4.21');